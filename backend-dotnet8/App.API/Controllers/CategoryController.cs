...
public class CategoryController : ControllerBase
{
    ...
    public CategoryController(ICategoryService service, ILogService logService, IHttpContextAccessor httpContextAccessor)
    {
        _Service = service;
    ...
    [HttpPost("add")]
    public async Task<IActionResult> Add(CategoryDto req)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(CategoryDto req)
    {
        ResponseDto resp = new ResponseDto();
        var reqTime = DateTime.UtcNow;
        var stopwatch = Stopwatch.StartNew(); // Start timing
    ...
    [HttpPost("active")]
    public async Task<IActionResult> Active(CategoryActiveDto req)
    {
        ResponseDto resp = new ResponseDto();
        var reqTime = DateTime.UtcNow;
        var stopwatch = Stopwatch.StartNew(); // Start timing
