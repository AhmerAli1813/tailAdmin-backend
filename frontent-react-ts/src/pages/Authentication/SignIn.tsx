              ...
              <form onSubmit={handleSubmit(onSubmitLoginForm)}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <InputField control={control} ClassName='w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary' inputName='userName' error={errors.userName?.message} />
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <InputField inputType='password' control={control} Placeholder='6+ Characters, 1 Capital letter' ClassName='w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary' inputName='password' error={errors.password?.message} />
